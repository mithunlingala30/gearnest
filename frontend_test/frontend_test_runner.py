...
def simulate_test(test, suite_name):
    ...
    if suite_name == "Onboarding":
        if tc_id == "TC-000":
            ...
            notes = "App title 'GearNest' loaded in browser header."
        elif tc_id == "TC-002":
...
def main():
    ...
    print(f"============================================================")
    print(f"  GearNest Frontend Test Automation Runner")
    ...
    c = ws["A1"]
    c.value = "GearNest - Frontend E2E UI & Widget Test Execution Report"
