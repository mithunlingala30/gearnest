...
class FirebaseService {
  ...
  /// Streams all equipment items from Firestore (web browse/categories screen).
  Stream<List<Map<String, dynamic>>> streamEquipmentItems() {
    return _db
  ...
  /// Creates the Firebase Auth account and writes the profile to Firestore.
